...
class VQADataset(Dataset):
    def __init__(
        self, images_file, questions_file, answers_file, indices_file, device="cuda"
    ):
        """
        Args:
            ...
            device (str): Thiết bị để load dữ liệu ('cuda' hoặc 'cpu')
        """
...
def get_dataloader(
    ...
    Args:
        ...
        device (str): Thiết bị để load dữ liệu
    Returns:
        DataLoader object
    """
    dataset = VQADataset(
...
def get_all_dataloaders(data_dir, batch_size=32, device="cuda"):
    """
...
if __name__ == "__main__":
    ...
    dataloaders = get_all_dataloaders(data_dir, batch_size=32, device=device)
